...
addButton.addEventListener("click",function(){
	var _value=document.getElementById("item").value;
	if (_value != " ") {
...
function Tocomplete(){
	...
	var item=this.parentNode.parentNode;
	var parentlist=item.parentNode;
	var parentlistId=parentlist.id;
	console.log(parentlistId);
	
	
	if(parentlistId == "todo"){
...
function addTodoList(_text){
	...
	add.addEventListener("click",Tocomplete)
